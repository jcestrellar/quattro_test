...
#define APK_CERT_SHA1_LEN	(sizeof(APK_CERT_SHA1 ))

static const unsigned char APK_CERT_SHA1[] = {

#ifdef NDEBUG
  #ifndef CHECK_SIGNATURE
    #error "CHECK_SIGNATURE not defined!"
  #else
    /* Play Console: App signing key certificate - SHA-1 certificate fingerprint */
	SCRUMBLE_KEY1( 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 )
	SCRUMBLE_KEY2( 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 )
	SCRUMBLE_KEY3( 0x00, 0x00, 0x00, 0x00,    0,    0,    0,    0 )
  #endif
#else
	/* keytool -list -v -keystore build/android/app/debug.keystore -alias androiddebugkey -storepass android */
	SCRUMBLE_KEY1( 0xda, 0xcc, 0x70, 0xa7, 0x91, 0x62, 0xb1, 0x39 )
	SCRUMBLE_KEY2( 0xea, 0x79, 0x7f, 0xc8, 0x03, 0x35, 0x02, 0x97 )
	SCRUMBLE_KEY3( 0xd7, 0xed, 0xc6, 0x99,    0,    0,    0,    0 )
#endif
...
#ifdef NDEBUG
	/*
	 * download App signing key certificate from Play Console -> deployment_cert.der
	 * > openssl dgst -sha256 -sign libtg_private_key.pem deployment_cert.der | openssl asn1parse -inform der
	 *       SEQUENCE
	 *       INTEGER : ... (32 bytes)
	 *       INTEGER : ... (32 bytes)
	*/
...
#else
	/*
	 * > keytool -export -keystore build/android/app/debug.keystore -alias androiddebugkey -storepass android -file tmp.crt
	 * > openssl dgst -sha256 -sign libtg_private_key.pem tmp.crt | openssl asn1parse -inform der
	 *       SEQUENCE
	 *       INTEGER : ... (32 bytes)
	 *       INTEGER : ... (32 bytes)
	 */
	SCRUMBLE_KEY1( 0xba, 0x67, 0xd6, 0x37, 0x21, 0x4d, 0xdb, 0xa3 )
	SCRUMBLE_KEY2( 0x16, 0xb3, 0x47, 0xfc, 0x8c, 0x55, 0xe3, 0x39 )
	SCRUMBLE_KEY3( 0xc7, 0x19, 0x9d, 0x07, 0x3e, 0x56, 0xd0, 0x9e )
	SCRUMBLE_KEY4( 0x32, 0x49, 0x02, 0x68, 0x33, 0x0a, 0x2e, 0x4b )
	SCRUMBLE_KEY5( 0x3c, 0x9e, 0x01, 0xa7, 0x23, 0xf0, 0x98, 0xf5 )
	SCRUMBLE_KEY6( 0x4f, 0x2c, 0xb2, 0x46, 0x06, 0x64, 0x5e, 0x8c )
	SCRUMBLE_KEY1( 0x4c, 0xdc, 0xe9, 0xda, 0x7e, 0xf5, 0x07, 0x40 )
	SCRUMBLE_KEY2( 0x39, 0x18, 0xd0, 0x02, 0x32, 0x00, 0xdd, 0x1f )
#endif
